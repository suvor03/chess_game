...
public abstract class Piece{
     ...
     * @return true if it is the piece's current turn & the move is within its potential moves
     */
    ...
    /**
     * Provides all the raw moves (all moves, without considering potential checks) possible for a given piece within a certain board
