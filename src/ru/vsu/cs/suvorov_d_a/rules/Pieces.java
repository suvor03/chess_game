package ru.vsu.cs.suvorov_d_a.rules;

import ru.vsu.cs.suvorov_d_a.enums.COLOUR;
import ru.vsu.cs.suvorov_d_a.enums.ID;
import ru.vsu.cs.suvorov_d_a.figures.Bishop;
import ru.vsu.cs.suvorov_d_a.figures.King;
import ru.vsu.cs.suvorov_d_a.figures.Pawn;
...
public class Pieces {
     ...
     *
     * gameProgress is an ArrayList, contain HashMaps with Coordinate-Piece key-value pairs,
    ...
    public Pieces() {
        ...
        updatePotentials(); // when we instantiate Pieces, we immediately calculate the potential moves to begin the game
    }
