...
public class King extends Piece {
    ...
    // the coordinate to which the king goes after castling Queen side
     ...
     * If the king can castle, then the coordinate to which the king goes to castle is added to castleCoordKing
    ...
    public ArrayList<Coordinate> getRawMoves(Pieces pieces) {
        ...
        // if it can castle, add coordinates
