...
public class Pawn extends Piece {
     ...
     * Sets promotedPiece to the correct user input
    ...
    public Piece promotionQuery(Coordinate promotionSquare) {
        ...
        while (!correctInput) {
            ...
            switch (promoted) {
                case "Queen", "Q" -> {
                    promote = new Queen(getColour(), promotionSquare);
                    correctInput = true;
                }
                case "Rook", "R" -> {
                    promote = new Rook(getColour(), promotionSquare);
                    correctInput = true;
                }
                case "Bishop", "B" -> {
                    promote = new Bishop(getColour(), promotionSquare);
                    correctInput = true;
                }
                case "Knight", "N" -> {
                    promote = new Knight(getColour(), promotionSquare);
                    correctInput = true;
                }
